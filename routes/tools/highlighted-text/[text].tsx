...
import { syntaxHighlightClassesStyles } from "../../../data/syntax-highlight/syntaxHighlightClassesStyles.ts";
//? Import Twind config example
import { syntaxHighlightTwindConfig } from "../../../data/syntax-highlight/syntaxHighlightTwindConfig.ts";
