...
const timestampScript = <script dangerouslySetInnerHTML={{
  __html: `const timestamps = document.getElementsByClassName("date-timestamp");
  ...
  \`Completed on \${parsedTimestamp.toLocaleDateString()}\`;
}`}} />
  ...
  return (
    <>
      ...
      <article class="flex flex-col h-full w-full max-w-4xl mx-auto items-center">
        ...
        {pythonAutomationCertificate}
        {reactNextCertificate}
        {nodeBackendCertificate}
      </article>
...
const cleanCodeCertificate = <section class="flex flex-col items-center">
  ...
  <p class="mt-2 mb-4 text-justify w-full">
...
const pythonAutomationCertificate = <section class="flex flex-col items-center">
...
const reactNextCertificate = <section class="flex flex-col items-center">
...
const nodeBackendCertificate = <section class="flex flex-col items-center">
